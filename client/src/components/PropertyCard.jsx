...
<div className="p-3 sm:p-4 bg-white flex flex-col justify-between">
  <div>
    {/* Title */}
    <h3 className="font-serif text-base font-bold text-[#0D0D0D] truncate mb-1">
      Spacious 2BHK...
    </h3>
    ...
    <div className="flex items-center gap-1 text-xs text-[#6B6B6B] mb-3">
      ...
      <span className="truncate">Bageshree, Nanded City, Pune</span>
    </div>
    ...
    <div className="flex items-center gap-6 mb-3">
      <div>
        ...
        <span className="text-sm font-bold text-[#0D0D0D]">₹62.0 L</span>
      </div>
      <div>
        <span className="block text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Rent</span>
        <span className="text-sm font-bold text-[#0D0D0D]">₹20K/mo</span>
      </div>
    </div>
  </div>
  ...
  <div className="pt-2.5 border-t border-gray-100 flex items-center gap-1.5">
    ...
    <a
  href="mailto:vidya.nk07@gmail.com?subject=Inquiry%20for%20Spacious%202BHK"
